...
\begin{proof}
	...
	To see that \lref{en:inv:ample3} implies \lref{en:inv:ample1}, let $\cF \in \Coh(X)$ be a coherent sheaf.
	%By assumption, we can then find an $m_0 > 0$ so that for all $m \geq m_0$, the sheaf $\cF \tensor_{\cO_X} \cL^{\tensor mn}$ is globally generated.

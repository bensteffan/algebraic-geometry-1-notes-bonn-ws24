...
% TODO check this
\begin{example}
	If $k$ is a field and $n > 0$, then $\CaCl(\P^n_k) \isom \isom \Pic(\P^n_k) \Cl(\P^n_k) \isom \Z$ with $\Pic(\P^n_k)$ generated by $\cO_{\P^n_k}(1)$, and $\Cl(\P^n_k)$ generated the class of any hyperplane $H = V_+(x_i)$, $0 \leq i \leq n$.
